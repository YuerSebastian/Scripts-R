...
for (i in 1:length(x)) {
  ...
  if (length(rownames(Rep))>0) {
    ...
    if(i!=1) Base <- rbind(Base,Rep) else Base <- Rep
...
googledrive::drive_put("C:/Users/jsalinba/Documents/Reportes/Bases/Principales/Respuestas talleres.csv","Principales/")
